...
namespace QBRT
{
	class QBSimpleRefractive : public QBMaterialBase
	{
		public:
			...
			QBSimpleRefractive();
			QBSimpleRefractive(	const qbVector3<double>& vColour, 
			...
			qbVector3<double>			ComputeSpecular(	const std::vector<std::shared_ptr<QBRT::QBObjectBase>>& vObjectList,
															const std::vector<std::shared_ptr<QBRT::QBLightBase>>& vLightList,
															const qbVector3<double>& vIntersectionPoint,
															const qbVector3<double>& vLocalNormal,
			...
			qbVector3<double>			ComputeTranslucency(	const std::vector<std::shared_ptr<QBRT::QBObjectBase>>& vObjectList,
																const std::vector<std::shared_ptr<QBRT::QBLightBase>>& vLightList,
																const std::shared_ptr<QBRT::QBObjectBase>& pCurrentObject,
																const qbVector3<double>& vIntersectionPoint,
																const qbVector3<double>& vLocalNormal,
