...
std::shared_ptr<QBRT::RM::QBRMCube> QBRT::QBUtils::AddRMCube(	std::vector<std::shared_ptr<QBRT::QBObjectBase>>& vObjectList,
...
std::shared_ptr<QBRT::RM::QBRMTorus> QBRT::QBUtils::AddRMTorus(	std::vector<std::shared_ptr<QBRT::QBObjectBase>>& vObjectList,
																const qbVector3<double>& vTranslation,
																const qbVector3<double>& vRotation,
																const qbVector3<double>& vScaling,
																const std::shared_ptr<QBRT::QBMaterialBase>& material,
...
std::shared_ptr<QBRT::RM::QBRMSphere> QBRT::QBUtils::AddRMSphere(	std::vector<std::shared_ptr<QBRT::QBObjectBase>>& vObjectList,
																	const qbVector3<double>& vTranslation,
																	const qbVector3<double>& vRotation,
																	const qbVector3<double>& vScaling,
																	const std::shared_ptr<QBRT::QBMaterialBase>& material,
...
std::shared_ptr<QBRT::QBObjectSphere> QBRT::QBUtils::AddSphere(	std::vector<std::shared_ptr<QBRT::QBObjectBase>>& vObjectList,
																const qbVector3<double>& vTranslation,
																const qbVector3<double>& vRotation,
																const qbVector3<double>& vScaling,
																const std::shared_ptr<QBRT::QBMaterialBase>& material,
...
std::shared_ptr<QBRT::QBObjectPlane> QBRT::QBUtils::AddPlane(	std::vector<std::shared_ptr<QBRT::QBObjectBase>>& vObjectList,
																const qbVector3<double>& vTranslation,
																const qbVector3<double>& vRotation,
																const qbVector3<double>& vScaling,
																const std::shared_ptr<QBRT::QBMaterialBase>& material,
...
std::shared_ptr<QBRT::QBCylinder> QBRT::QBUtils::AddCylinder(	std::vector<std::shared_ptr<QBRT::QBObjectBase>>& vObjectList,
																const qbVector3<double>& vTranslation,
																const qbVector3<double>& vRotation,
																const qbVector3<double>& vScaling,
																const std::shared_ptr<QBRT::QBMaterialBase>& material,
																...
																bool bAddToList)
{
	...
	if (bAddToList) vObjectList.push_back(objCylinder);
	{
...
std::shared_ptr<QBRT::QBCone> QBRT::QBUtils::AddCone(	std::vector<std::shared_ptr<QBRT::QBObjectBase>>& vObjectList,
														const qbVector3<double>& vTranslation,
														const qbVector3<double>& vRotation,
														const qbVector3<double>& vScaling,
														const std::shared_ptr<QBRT::QBMaterialBase>& material,
														...
														bool bAddToList)
{
	...
	if(bAddToList) vObjectList.push_back(objCone);
	{
...
std::shared_ptr<QBRT::QBBox> QBRT::QBUtils::AddBox(		std::vector<std::shared_ptr<QBRT::QBObjectBase>>& vObjectList,
														const qbVector3<double>& vTranslation,
														const qbVector3<double>& vRotation,
														const qbVector3<double>& vScaling,
														const std::shared_ptr<QBRT::QBMaterialBase>& material,
