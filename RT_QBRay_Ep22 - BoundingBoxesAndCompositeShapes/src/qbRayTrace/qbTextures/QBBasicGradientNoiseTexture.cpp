#include "QBBasicGradientNoiseTexture.hpp"
#include <algorithm>

// Constructor / destructor.
QBRT::QBTexture::QBBasicGradientNoiseTexture::QBBasicGradientNoiseTexture()
{
...
qbVector4<double> QBRT::QBTexture::QBBasicGradientNoiseTexture::GetColor(const qbVector2<double>& vUVCoords)
{
...
double QBRT::QBTexture::QBBasicGradientNoiseTexture::GetValue(const qbVector2<double>& vUVCoords)
{
...
void QBRT::QBTexture::QBBasicGradientNoiseTexture::SetColorMap(const std::shared_ptr<QBRT::QBTexture::QBColourMap>& colorMap)
{
	m_colorMap = colorMap;
...
void QBRT::QBTexture::QBBasicGradientNoiseTexture::SetAmplitude(double fAmplitude)
{
	m_fAmplitude = fAmplitude;
}

// Function to set the scale.
void QBRT::QBTexture::QBBasicGradientNoiseTexture::SetScale(int iScale)
{
	m_iScale = iScale;
