...
double QBRT::QBTexture::QBTextureBase::GetValue(const qbVector2<double>& vUVCoords)
{
...
void QBRT::QBTexture::QBTextureBase::SetTransform(	const qbVector2<double>& vTranslation,
