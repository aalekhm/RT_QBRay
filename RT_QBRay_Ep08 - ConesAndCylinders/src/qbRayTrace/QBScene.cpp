...
QBRT::QBScene::QBScene()
{
	...
	QBRT::QBUtils::AddCone(	m_vObjectList, 
							...
							MAKE_SIMPLE_MATERIAL(MAKE_COLOUR(0.5, 0.5, 0.8), 0.5, 20.0));
	...
	QBRT::QBUtils::AddSphere(	m_vObjectList,
								...
								MAKE_SIMPLE_MATERIAL(MAKE_COLOUR(0.2, 0.2, 0.8), 0.05, 5.0));
	...
	QBRT::QBUtils::AddSphere(	m_vObjectList,
								...
								MAKE_SIMPLE_MATERIAL(MAKE_COLOUR(0.8, 0.8, 0.2), 0.05, 5.0));
	...
	QBRT::QBUtils::AddSphere(	m_vObjectList,
								...
								MAKE_ROTATION(0.0, 0.0, 0.0),
								MAKE_SCALE(0.5, 0.5, 0.5),
								MAKE_SIMPLE_MATERIAL(MAKE_COLOUR(1.0, 0.5, 0.0), 0.05, 5.0));
	...
	QBRT::QBUtils::AddPlane(	m_vObjectList,
								...
								MAKE_SIMPLE_MATERIAL(MAKE_COLOUR(1.0, 1.0, 1.0), 0.0, 0.0));
	...
	QBRT::QBUtils::AddCylinder(	m_vObjectList,
								...
								MAKE_SIMPLE_MATERIAL(MAKE_COLOUR(0.8, 0.8, 0.3), 0.25, 20.0));
