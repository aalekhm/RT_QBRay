...
QBRT::QBScene::QBScene()
{
	...
	{
		imageTexture->LoadImage("C:\\GitHub\\aalekhm\\RayTracing\\RT_QBRay\\Content\\Voronoi.bmp");
	...
	{
		imageNormalMap->LoadImage("C:\\GitHub\\aalekhm\\RayTracing\\RT_QBRay\\Content\\Voronoi_normal.bmp");
