...
qbVector3<double> QBRT::QBNormal::QBImageNormal::ComputePerturbation(const qbVector3<double>& vNormal, const qbVector2<double>& vUVCoords)
{
	...
	{	
		...
		double interpR = BilinearInterp(xMin, yMin,		vColour0.r, xMax, yMin,		vColour1.r, xMin, yMax,		vColour2.r, xMax, yMax,		vColour3.r, xF, yF);
		double interpG = BilinearInterp(xMin, yMin,		vColour0.g, xMax, yMin,		vColour1.g, xMin, yMax,		vColour2.g, xMax, yMax,		vColour3.g, xF, yF);
		double interpB = BilinearInterp(xMin, yMin,		vColour0.b, xMax, yMin,		vColour1.b, xMin, yMax,		vColour2.b, xMax, yMax,		vColour3.b, xF, yF);
...
double QBRT::QBNormal::QBImageNormal::LinearInterp(	const double& x0,
													const double& y0,
													const double& x1,
													const double& y1,
													const double& x)
...
double QBRT::QBNormal::QBImageNormal::BilinearInterp(	const double &x0, const double &y0, const double &v0,
