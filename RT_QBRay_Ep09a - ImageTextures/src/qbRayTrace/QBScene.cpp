...
QBRT::QBScene::QBScene()
{
	...
	std::shared_ptr<QBRT::QBSimpleMaterial> pMatSphere = MAKE_SIMPLE_MATERIAL(MAKE_COLOUR(1.0, 0.2, 0.2), 0.8, 32.0);
	std::shared_ptr<QBRT::QBSimpleMaterial> pMatSphere2 = MAKE_SIMPLE_MATERIAL(MAKE_COLOUR(0.2, 1.0, 0.2), 0.8, 32.0);
	std::shared_ptr<QBRT::QBSimpleMaterial> pMatSphere3 = MAKE_SIMPLE_MATERIAL(MAKE_COLOUR(0.2, 0.2, 1.0), 0.8, 32.0);
