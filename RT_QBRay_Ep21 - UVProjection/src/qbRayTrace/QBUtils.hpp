...
#define ADD_CYLINDER(	_OBJLIST_, _TRANSLATION_, _ROTATION_, _SCALING_, _MATERIAL_, _FRIENDLY_NAME_) QBRT::QBUtils::AddCylinder(	_OBJLIST_, _TRANSLATION_, _ROTATION_, _SCALING_, _MATERIAL_, _FRIENDLY_NAME_);
#define ADD_CONE(		_OBJLIST_, _TRANSLATION_, _ROTATION_, _SCALING_, _MATERIAL_, _FRIENDLY_NAME_) QBRT::QBUtils::AddCone(		_OBJLIST_, _TRANSLATION_, _ROTATION_, _SCALING_, _MATERIAL_, _FRIENDLY_NAME_);
...
namespace QBRT
{
	...
	class QBUtils
	{
		public:
			...
			static QBRT::QBObjectSphere* AddSphere(	std::vector<std::shared_ptr<QBRT::QBObjectBase>>& vObjectList,
													const qbVector3<double>& vTranslation,
													const qbVector3<double>& vRotation,
													const qbVector3<double>& vScaling,
													const std::shared_ptr<QBRT::QBMaterialBase>& material,
			...
			static QBRT::QBObjectPlane* AddPlane(	std::vector<std::shared_ptr<QBRT::QBObjectBase>>& vObjectList,
													const qbVector3<double>& vTranslation,
													const qbVector3<double>& vRotation,
													const qbVector3<double>& vScaling,
													const std::shared_ptr<QBRT::QBMaterialBase>& material,
